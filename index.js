...
var startingUrl = 'https://www.letsrevolutionizetesting.com/challenge';
var fs = require('node:fs');
function fetchUrl(url) {
    return __awaiter(this, void 0, void 0, function () {
        var headers, options, response, json;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (json.follow) {
                        ...
                        return [2 /*return*/, recursiveFetch(json.follow)];
                    }
                    else {
